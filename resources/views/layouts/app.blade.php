...
<header>
    <div class="container-fluid header">
        <div class="row align-item-start">
            ...
            <div class="col-4 col-sm-4 col-md-4 col-lg-4 justify-content-center">
                <h1>PROYECTOS MUSICALES</h1>
            </div>

            <div class="col-xs-8 col-sm-8 col-md-4 col-lg-4 justify-content-end">
                <a href="{{url('acceder')}}" class="btn-login"> <button class="btn-inicio" >Iniciar Sesión como fans</button></a>
                <a href="{{url('accederUser')}}" class="btn-login"> <button class="btn-inicio">Iniciar Sesión como usuario</button></a>
            </div>
